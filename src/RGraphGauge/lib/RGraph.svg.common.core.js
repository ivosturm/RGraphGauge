...
var a;var x=parseFloat(obj.svg.getAttribute('width'))-2,y=parseFloat(obj.svg.getAttribute('height'))-2;if(typeof prop.attributionX==='string'){x+=parseFloat(prop.attributionX);}else if(typeof prop.attributionX==='number'){x=parseFloat(prop.attributionX);}
...
var text;};RG.SVG.random=function(min,max)
